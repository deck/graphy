 ...
 *  --
 *
 *  File modified to stand-alone and support css color names by Joel @ DECK.
 *
 */
 ...
 */
Rico.RGBColor = function(red, green, blue) {
   ...
   this.blend = function(other) {
     if (other.substr) { other = Rico.Color.create(other); }
   ...
   this.asHex = function() {
      return "#" + Rico.Color.toColorPart(this.rgb.r) + Rico.Color.toColorPart(this.rgb.g) + Rico.Color.toColorPart(this.rgb.b);
   };
...
Rico.Color.toColorPart = function(n) {
  var string = n.toString(16);
  if ( string.length == 1 ) { string = "0" + string; }
  return string;
}

Rico.Color.create = function(s) {
  var hex = ( s.substr(0,1) == "#"  ) ? s : Rico.Color.nameToHex(s);
  return Rico.Color.createFromHex(hex);
}
 ...
 * @returns a Rico.RGBColor object
 */
Rico.Color.createFromHex = function(hexCode) {
  ...
  return new Rico.RGBColor( parseInt(red,16), parseInt(green,16), parseInt(blue,16) );
};
...
Rico.Color.nameToHex = function(s) {
    if (s.substr(0,2) == "0x"){
      return s.substr(2, s.length);
    }
    else{
      return "#" + Rico.Color.colorNames[s];
    }
}

Rico.Color.colorNames = {
    aliceblue: 'f0f8ff',
    antiquewhite: 'faebd7',
    aqua: '00ffff',
    aquamarine: '7fffd4',
